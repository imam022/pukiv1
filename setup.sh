...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/imam022/titid/main/ip"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"http://wa.me/+6281934641091"}]]}' 
...
# set locale
DEBIAN_FRONTEND=noninteractive sed -i 's/AcceptEnv/#AcceptEnv/g' /etc/ssh/sshd_config
...
wget -q https://raw.githubusercontent.com/imam022/pukiv1/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
function noobzvpn(){
clear
wget --no-check-certificate https://raw.githubusercontent.com/imam022/pukiv1/main/noobzvpns.zip
unzip noobzvpns.zip
cd noobzvpns
bash install.sh
rm noobzvpns.zip
...
cd
    ...
    wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/imam022/pukiv1/main/encrypt/encrypt" ; chmod +x /usr/bin/enc
